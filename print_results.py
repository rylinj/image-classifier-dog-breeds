...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            ...
            classification_label = results_dic[key][1]
            is_match = results_dic[key][2]
            pet_image_is_dog = results_dic[key][3] == 1 and "is-a-dog" or "is-NOT-a-dog"
            classification_image_is_dog = results_dic[key][4] == 1 and "is-a-dog" or "is-NOT-a-dog"

            if pet_image_is_dog != classification_image_is_dog:
                print("{} {} and {} {}".format(
                    pet_label, pet_image_is_dog, classification_label, classification_image_is_dog
                ))
